...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
	try {
	    Environment.SYSTEM_VERSION = "KT [Colonia] 20190721 - RCG";
	    Environment.minVersion = 20110424;
	    setUndecorated(true);
	...
	if (active) {
	    ...
	    KeyStroke activateMain = KeyStroke.getKeyStroke( KeyEvent.VK_1, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateMainListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateMainListener, "activateMain", activateMain, JComponent.WHEN_IN_FOCUSED_WINDOW );


	    KeyStroke activateTaxes = KeyStroke.getKeyStroke( KeyEvent.VK_2, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateTaxesListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateTaxesListener, "activateTaxes", activateTaxes, JComponent.WHEN_IN_FOCUSED_WINDOW );

	    KeyStroke activateCashflow = KeyStroke.getKeyStroke( KeyEvent.VK_3, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateCashflowListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateCashflowListener, "activateCashflow", activateCashflow, JComponent.WHEN_IN_FOCUSED_WINDOW );

	    KeyStroke activateResources = KeyStroke.getKeyStroke( KeyEvent.VK_4, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateResourcesListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateResourcesListener, "activateResources", activateResources, JComponent.WHEN_IN_FOCUSED_WINDOW );

	    KeyStroke activateAssets = KeyStroke.getKeyStroke( KeyEvent.VK_5, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateAssetsListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateAssetsListener, "activateAssets", activateAssets, JComponent.WHEN_IN_FOCUSED_WINDOW );

	    KeyStroke activateReports = KeyStroke.getKeyStroke( KeyEvent.VK_6, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateReportsListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateReportsListener, "activateReports", activateReports, JComponent.WHEN_IN_FOCUSED_WINDOW );

	    KeyStroke activateGAIA = KeyStroke.getKeyStroke( KeyEvent.VK_7, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateGAIAListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateGAIAListener, "activateGAIA", activateGAIA, JComponent.WHEN_IN_FOCUSED_WINDOW );

	    KeyStroke activateSticky = KeyStroke.getKeyStroke( KeyEvent.VK_8, InputEvent.ALT_DOWN_MASK);
	    ActionListener activateStickyListener = new ActionListener()  {
	    ...
	    rootPane.registerKeyboardAction(activateStickyListener, "activateSticky", activateSticky, JComponent.WHEN_IN_FOCUSED_WINDOW );
