...
public class ElSuriDesktop {
	...
	*/
	Environment.mainClass = ElSuriDesktop.class;
	Boot.initGraphics();
	Environment.organization = "UNSa";
	OrganizationInfo.setOrgName("UNSa");
	OrganizationInfo.setTitle("UNSa");
	OrganizationInfo.setShortName("UNSa");
	OrganizationInfo.setDescription("Universidad Nacional de Salta");
        OrganizationInfo.setAddress("Av. Bolivia S/N - Ciudad del Milagro - Salta"); 
	OrganizationInfo.setShortAddress("Av. Bolivia S/N");
	...
	OrganizationInfo.setCountry("República Argentina");
        OrganizationInfo.setWebAddress("http://www.unsa.edu.ar");
        OrganizationInfo.setPhoneNumber1("(0387) 9999999");
        OrganizationInfo.setPhoneNumber2("(0387) 9999999");
