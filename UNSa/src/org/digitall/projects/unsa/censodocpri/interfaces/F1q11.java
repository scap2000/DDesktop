...
public class F1q11 extends BasicPrimitivePanel {
	...
	lblf1q11.setText(encuesta.getF1q11Label());

	lblf1q11.setBounds(new Rectangle(15, 25, 640, 55));
	lblf1q11.getTextArea().setFont(new Font("Dialog", 1, 12));
	lblf1q11.getTextArea().setForeground(Color.white);
	lblf1q11.getTextArea().setOpaque(false);
	lblf1q11.setEditable(false);
	tff1q11.setBounds(new Rectangle(15, 85, 640, 125));

	contentPane.add(tff1q11, null);
	contentPane.add(lblf1q11, null);
	this.setContent(contentPane);
	this.setSize(new Dimension(675, 257));
	addButton(btnNext);
	addButton(btnPrevious);
	
	tff1q11.setText(encuesta.getF1q11());
	tff1q11.setEditable(coordinador.isWritable());
	...
	if (coordinador.isWritable()) {
	    encuesta.setF1q11(tff1q11.getText());
	}
