...
public class Boot {
	...
	switch (_action) {
		...
		/**
		     * CODIGO DE INICIO DEL MODULO
		     * */
		new ExtendedInternalFrame("GIS del\nRelevamiento Comercial 2009\n(Beta)", IconTypes.gaia, GEARelevamientoComercial.class, true, _desktop);
		/**
		     * FIN CODIGO DE INICIO DEL MODULO
		     * */
    ...
    public static void rcGEARecaudacion(int _action, final BasicDesktop _desktop) {
	LibSQL.setVerboseMode(false);
	long initTime = System.currentTimeMillis();
	switch (_action) {
	    case INIT_START:
		...
		/**
		     * CODIGO DE INICIO DEL MODULO
		     * */
		new ExtendedInternalFrame("GIS 2010\n(Beta)", IconTypes.gaia, GEARecaudacion.class, true, _desktop);
		/**
		     * FIN CODIGO DE INICIO DEL MODULO
		     * */
		Environment.jpStatusBar.setAction("Gaia loaded");
