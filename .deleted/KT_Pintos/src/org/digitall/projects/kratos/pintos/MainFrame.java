...
import org.digitall.projects.gdigitall.gobiernodigitall.MainPanel;
...
public class MainFrame extends JFrame {
	...
	desktops[3] = new BasicDesktop(3, Environment.MODULE_ASSETS);
	desktops[4] = new BasicDesktop(4, Environment.MODULE_REPORTS);
	desktops[5] = new BasicDesktop(5, Environment.MODULE_STICKYNOTES);
	...
	if (active) {
	    ...
	    Boot.rcCommandCenterModule(Boot.INIT_START, Environment.getDesktop(Environment.MODULE_REPORTS));
	    ...
	    Boot.rcResourcesControlModule(Boot.INIT_START, Environment.getDesktop(Environment.MODULE_ASSETS));
