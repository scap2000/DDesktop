 ...
 * Time: 14:17:34
 */
public class ToggleCommandMenuItem extends JCheckBoxMenuItem implements CommandComponent
{
    @NotNull
    ...
    public ToggleCommandMenuItem(@NotNull final Presentation presentation, @NotNull String iconKey)
    {
