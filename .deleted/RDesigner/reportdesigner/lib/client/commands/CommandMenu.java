 ...
 * Time: 14:17:34
 */
public class CommandMenu extends JMenu implements CommandComponent
{
    @NotNull
    ...
    public CommandMenu(@NotNull final Presentation presentation, boolean showIcon, @NotNull String iconKey)
    {
