 ...
 * Time: 10:16:07
 */
public class BandsComponentHelper extends JComponent
{
    @NotNull
    private BandsComponent bandsComponent;


    public BandsComponentHelper(@NotNull BandsComponent bandsComponent)
    {
        this.bandsComponent = bandsComponent;
        setLayout(new BandsComponentHelperLayoutManager(this));
    }
