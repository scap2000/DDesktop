 ...
 * Time: 15:51:58
 */
public class BandToplevelGroupReportElementInfo extends BandToplevelReportElementInfo
{

    public BandToplevelGroupReportElementInfo(@NotNull BandToplevelType bandToplevelType)
    {
        super(bandToplevelType);
        if (bandToplevelType != BandToplevelType.GROUP_FOOTER && bandToplevelType != BandToplevelType.GROUP_HEADER)
        {
    ...
    {
        BandToplevelGroupReportElement bandToplevelReportElement = new BandToplevelGroupReportElement();
