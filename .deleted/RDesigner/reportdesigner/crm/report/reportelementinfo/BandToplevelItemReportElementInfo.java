 ...
 * Time: 15:51:58
 */
public class BandToplevelItemReportElementInfo extends BandToplevelReportElementInfo
{

    public BandToplevelItemReportElementInfo(@NotNull BandToplevelType bandToplevelType)
    {
        super(bandToplevelType);
        if (bandToplevelType != BandToplevelType.ITEM_BAND)
        {
    ...
    {
        BandToplevelItemReportElement bandToplevelReportElement = new BandToplevelItemReportElement();
