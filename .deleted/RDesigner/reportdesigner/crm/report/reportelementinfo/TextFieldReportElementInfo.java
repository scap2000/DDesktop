 ...
 * Time: 15:51:58
 */
public class TextFieldReportElementInfo extends ReportElementInfo
{
    public TextFieldReportElementInfo()
    {
        super(IconLoader.getInstance().getTextFieldReportElementIcon(), TranslationManager.getInstance().getTranslation("R", "ReportElementInfo.TextField"));
    }


    public TextFieldReportElementInfo(@NotNull Icon icon, @NotNull String title)
    {
        super(icon, title);
    }
    ...
    @NotNull
    public TextFieldReportElement createReportElement()
    {
