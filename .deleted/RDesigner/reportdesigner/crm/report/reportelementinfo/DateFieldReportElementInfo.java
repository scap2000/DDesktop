 ...
 * Time: 15:51:58
 */
public class DateFieldReportElementInfo extends TextFieldReportElementInfo
{
    public DateFieldReportElementInfo()
    {
        super(IconLoader.getInstance().getDateFieldReportElementIcon(), TranslationManager.getInstance().getTranslation("R", "ReportElementInfo.DateField"));
    }


    @NotNull
    public DateFieldReportElement createReportElement()
    {
