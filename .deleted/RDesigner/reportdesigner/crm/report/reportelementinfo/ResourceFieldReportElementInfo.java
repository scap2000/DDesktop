 ...
 * Time: 15:51:58
 */
public class ResourceFieldReportElementInfo extends TextFieldReportElementInfo
{
    public ResourceFieldReportElementInfo()
    {
        super(IconLoader.getInstance().getResourceFieldReportElementIcon(), TranslationManager.getInstance().getTranslation("R", "ReportElementInfo.ResourceField"));
    }


    @NotNull
    public ResourceFieldReportElement createReportElement()
    {
