...
public class SimpleRelativePositions
{
    public static void main(@NotNull String[] args) throws IOException, ReportWriterException
    {
        ...
        TextElement t2 = TextFieldElementFactory.createStringElement(
                "CustomerField",
                new Rectangle2D.Double(-30, 0, -20, 20),
                Color.black,
                ElementAlignment.LEFT,
        ...
        TextElement t3 = TextFieldElementFactory.createStringElement(
                "CityField",
                new Rectangle2D.Double(-60, 0, -20, 20),
                Color.black,
                ElementAlignment.LEFT,
                ElementAlignment.TOP,
                null, // font
        ...
        TextElement t4 = TextFieldElementFactory.createStringElement(
                "NumberField",
                new Rectangle2D.Double(-90, 0, -20, 20),
                Color.black,
                ElementAlignment.LEFT,
                ElementAlignment.TOP,
                null, // font
        ...
        config.setConfigProperty(Parser.CONTENTBASE_KEY, new File("C:\\Daten\\07_Projekte\\Report\\org.pentaho.reportdesigner.crm.report\\xml\\SimpleRelativePositions.xml").toURI().toURL().toExternalForm());
        ...
        FileWriter fileWriter = new FileWriter("C:\\Daten\\07_Projekte\\Report\\org.pentaho.reportdesigner.crm.report\\xml\\SimpleRelativePositions.xml");
