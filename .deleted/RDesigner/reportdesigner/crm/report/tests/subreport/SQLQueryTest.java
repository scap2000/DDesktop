...
public class SQLQueryTest
{
    public static void main(String[] args) throws Exception
    {
        ...
        sqlReportDataFactory.setQuery("query1", "select * from customers");
        sqlReportDataFactory.setQuery("subQuery1", "select * from addresses where address_id = ${ADDRESS_ID}");
        ...
        TextElement textElement2 = TextFieldElementFactory.createStringElement("reportField2", new Rectangle(100, 0, 100, 20), Color.BLACK, ElementAlignment.LEFT, ElementAlignment.TOP, new FontDefinition("Arial", 12), "-", "ADDRESS_ID");
        report.getItemBand().addElement(textElement2);

        SubReport subReport = new SubReport();
        subReport.addInputParameter("ADDRESS_ID", "ADDRESS_ID");

        subReport.setQuery("subQuery1");
        TextElement subReportTextElement = TextFieldElementFactory.createStringElement("subreportField1", new Rectangle(200, 0, 300, 20), Color.RED, ElementAlignment.LEFT, ElementAlignment.TOP, new FontDefinition("Arial", 12), "-", "ADDRESSLINE1");
