 ...
 * Time: 09:15:46
 */
public class PageDefinitionTableCellRenderer extends DefaultTableCellRenderer
{
    @NotNull
    public Component getTableCellRendererComponent(@NotNull JTable table, @Nullable Object value, boolean isSelected, boolean hasFocus, int row, int column)
    {
        ...
        try
        {
            if (value instanceof HashSet)
            {
                ...
                if (hashSet.size() == 1)
                {
                    PageDefinition pageDefinition = (PageDefinition) hashSet.iterator().next();
                    label.setText(pageDefinition.getNiceName());
                }
