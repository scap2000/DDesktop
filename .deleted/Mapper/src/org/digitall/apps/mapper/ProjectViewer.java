...
public class ProjectViewer extends BasicInternalFrame {
    ...
    public ProjectViewer(JDesktopPane _desktop, int _idProject, String _projectName) {
	try {
	    desktop = _desktop;
	...
	if (idProject != -1) {
		...
		if (coordinateViewer != null) {
		    ...
		    Layer _layer = new Layer("files", "file","polygons","points","idpolygon = " + 2, "idpolygon");
		    _layer.setProjectionType(CoordinateSystems.GK);
		    panel.addLayer(_layer);
		}
