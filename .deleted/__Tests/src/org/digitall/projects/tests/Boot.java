		...
		if (MAIN_MODULE_STATUS != STATUS_RUNNING) {
		    ...
		    btnTest.addActionListener(new ActionListener() {
					...
					cityMap.setCoordinateViewer(coordinateViewer);
				        ...
				        //Environment.getDesktops()[1].add(coordinateViewer);
				        Environment.getDesktops()[1].add(cityMap);
				        cityMap.setBounds(Environment.getActiveDesktop().getBounds());
					Environment.getDesktops()[1].setActive(true);
				        ...
				        Layer fracciones_desvinculadas = new Layer("fracciones_desvinculadas", "gis_mosconi", "fracciones_desvinculadas", "the_geom", "1=1", "gid");
					...
					nros_fracciones.setPointDiameter(16);
				        ...
				        Layer calles = new Layer("calles", "gis_mosconi", "calles", "the_geom", "1=1", "gid", "nombre");
					...
					GaiaEnvironment.streetsLayer = calles.getName();
				        GaiaEnvironment.scheme = "gis_mosconi";
				        ...
				        Layer manzanas_vinculadas = new Layer("manzanas_vinculadas", "gis_mosconi", "manzanas_vinculadas", "the_geom", "idmanzana<100000", "idmanzana");
				        ...
				        Layer parcelas_vinculadas = new Layer("parcelas_vinculadas", "gis_mosconi", "parcelas_vinculadas", "the_geom", "1=1", "idparcela", "catastros");
				        parcelas_vinculadas.setProjectionType(CoordinateSystems.GK);
					...
					parcelas_vinculadas.setQueryable(true);
				        ...
				        parcelas_desvinculadas.setColor(Color.RED.brighter());
				        parcelas_desvinculadas.setMouseOverColor(Color.BLUE.brighter());
				        parcelas_desvinculadas.setQueryable(true);
				        parcelas_desvinculadas.setInfoPanel(parcelPanelContainer);

				        Layer parcelas_deuda_tgs = new Layer("parcelas_deuda_tgs", "gis_mosconi", "parcelas_vinculadas", "the_geom", "1=1", "idparcela");
				        parcelas_deuda_tgs.setProjectionType(CoordinateSystems.GK);
				     ...
				     /*   parcelas_deuda_tgs.addFilter("(SELECT anticipostgs FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) <= 1", Color.black, Color.GREEN);
				        parcelas_deuda_tgs.addFilter("(SELECT anticipostgs FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) <= 12", Color.black, Color.YELLOW);
				        parcelas_deuda_tgs.addFilter("(SELECT anticipostgs FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) <= 60", Color.black, Color.RED);
				        parcelas_deuda_tgs.addFilter("(SELECT anticipostgs FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) > 60", Color.black, Color.GRAY);
*/
				        Layer parcelas_deuda_inmob = new Layer("parcelas_deuda_inmob", "gis_mosconi", "parcelas_vinculadas", "the_geom", "1=1", "idparcela");
				        parcelas_deuda_inmob.setProjectionType(CoordinateSystems.GK);
...
/*				        parcelas_deuda_inmob.addFilter("(SELECT anticiposinmob FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) <= 1", Color.black, Color.GREEN);
				        parcelas_deuda_inmob.addFilter("(SELECT anticiposinmob FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) <= 12", Color.black, Color.YELLOW);
				        parcelas_deuda_inmob.addFilter("(SELECT anticiposinmob FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) <= 60", Color.black, Color.RED);
				        parcelas_deuda_inmob.addFilter("(SELECT anticiposinmob FROM gis_mosconi.deudasxidparcela WHERE deudasxidparcela.idparcela = parcelas_vinculadas.idparcela) > 60", Color.black, Color.GRAY);
*/
				        ...
				        nros_parcelas.setPointDiameter(4);
    				        ...
    				        Layer infraestructura = new Layer("infraestructura", "gis_mosconi", "infraestructura", "the_geom", "1=1", "gid", "nombre", "tipo");
				        infraestructura.setProjectionType(CoordinateSystems.GK);
					...
					infraestructuraPanel.setLayer(infraestructura);
				        GaiaEnvironment.infrastructuresLayer = infraestructura.getName();

				        Layer direcciones = new Layer("direcciones", "gis_mosconi", "direcciones", "the_geom", "1=1", "gid", "numero");
				        direcciones.setProjectionType(CoordinateSystems.GK);
					...
					direcciones.setDrawGeometries(false);
				        ...
				        GaiaEnvironment.addressLayer = direcciones.getName();
				        ...
				        cityMap.addLayer(manzanas_desvinculadas);
				        cityMap.addLayer(fracciones_desvinculadas);
				        cityMap.addLayer(nros_fracciones);
				        cityMap.addLayer(canales);
				        cityMap.addLayer(agua);
				        cityMap.addLayer(espacios_verdes);
				        cityMap.addLayer(platabandas);
				        cityMap.addLayer(rutas);
				        cityMap.addLayer(veredas);
				        cityMap.addLayer(manzanas);
                                        cityMap.addLayer(parcelas_desvinculadas);
				        cityMap.addLayer(nros_manzanas);*/
				        cityMap.addLayer(parcelas_vinculadas);
				        cityMap.addLayer(calles);
				        cityMap.addLayer(direcciones);
				        cityMap.addLayer(infraestructura);
				        cityMap.addLayer(parcelas_deuda_tgs);
				        cityMap.addLayer(parcelas_deuda_inmob);
				        cityMap.addLayer(nros_parcelas);
				        ...
				        Environment.getDesktops()[1].add(layerListFrame);
				        layerListFrame.getContentPane().add(layerListPanel, null);
				        ...
				        Environment.getDesktops()[1].add(mapTools);
