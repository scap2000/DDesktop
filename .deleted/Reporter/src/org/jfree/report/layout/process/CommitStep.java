 ...
 */
public class CommitStep extends IterateStructuralProcessStep
{
  public CommitStep()
  {
  }
  ...
  {
    if (box.isAppliedSeen() && box.isAppliedOpen() == false)
    {
      return false;
    }
    box.setMarkedOpen(box.isOpen());
    box.setMarkedSeen(true);
    return true;
  }
