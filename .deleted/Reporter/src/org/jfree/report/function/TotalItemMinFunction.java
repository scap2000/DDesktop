 ...
 */
public class TotalItemMinFunction extends AbstractFunction
{
  /**
  ...
  public void reportInitialized(final ReportEvent event)
  {
    ...
    {
      this.min = (Comparable) results.get(globalStateKey);
    }
  }
  ...
  public void groupStarted(final ReportEvent event)
  {
    ...
    {
      this.min = null;
      results.put(globalStateKey, min);
      results.put(groupStateKey, min);
    }
    else
    {
      // Activate the current group, which was filled in the prepare run.
      min = (Integer) results.get(groupStateKey);
    }
  }
  ...
  public void itemsAdvanced(final ReportEvent event)
  {
    ...
    {
      Log.error("TotalItemMinFunction.advanceItems(): problem comparing values.");
    }
