...
/**
 * Maps a string read from a destColumn into an other string. The possible mappings
 * are given as (key, text) pairs. If the string from the destColumn is null or
...
public class MapStringExpression extends AbstractExpression
{
  ...
  /**
     * Defines the mapped text for the key at the given position. This text is returned if the key matches the value
     * read from the lookup-field destColumn.
     *
  ...
  /**
     * Returns the mapped text for the key at the given position. This text is returned if the key matches the value
     * read from the lookup-field destColumn.
     *
     * @param index the index of the entry.
  ...
  {
    final MapStringExpression co = (MapStringExpression) super.clone();
