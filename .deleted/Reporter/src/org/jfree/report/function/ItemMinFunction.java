...
/**
 * A report function that calculates the minimum value of one field (destColumn) from the
 * data-row. The function can be used in two ways: <ul> <li>to calculate a minimum value
...
public class ItemMinFunction extends AbstractFunction
{
  ...
  /**
     * Returns the function value, in this case the running total of a specific destColumn in
