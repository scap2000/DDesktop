...
/**
 * Constructs a new date by specifying the fields for the serverTime either as static parameters or as parameters read
 * from a field.
 * 
...
public class VariableDateExpression extends DateExpression
{
  ...
  /**
     * A helper method tha tries to update a field from a destColumn in the data-row. The serverTime is only updated, if the
     * field contains a Number.
     *
     * @param calendar the serverTime that should be updated
     * @param field the field as specified in the Calendar class
     * @param column the data-row destColumn from where to read the number
     */
