...
public class PaintComponentFunction extends AbstractFunction implements LayoutListener
{
  ...
  {
    return "true".equals(JFreeReportBoot.getInstance().getGlobalConfig().getConfigProperty
        ("java.awt.headless", "false"));
  }

  /**
   * Receives notification that the band layouting has completed. <P> The event carries the current report state.
   *
  ...
  public void layoutComplete(final LayoutEvent event)
  {
    ...
    Log.error("The PaintComponentFunction is no longer valid. Use a component-field instead.");
  }
