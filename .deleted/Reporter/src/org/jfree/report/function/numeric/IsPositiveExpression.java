...
/**
 * Checks, whether the destColumn specified by the field name contains a positive number.
 *
...
public class IsPositiveExpression extends AbstractExpression
{
  ...
  /**
     * Checks, whether the destColumn specified by the field name contains a positive number. Non-numeric values are not
