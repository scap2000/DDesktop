 ...
 *
 * ------------
 * ElementTrafficLightFunction.java
 * ------------
 * (C) Copyright 2001-2007, by Object Refinery Ltd, Pentaho Corporation and Contributors.
 */
...
public class ElementTrafficLightFunction extends AbstractElementFormatFunction
{
  ...
  /**
     * The name of the data-row destColumn from where to read the number that is compared to the limits.
     */
  ...
  /**
     ...
     * <p/>
     * The field name corresponds to a destColumn name in the data-row.
     *
