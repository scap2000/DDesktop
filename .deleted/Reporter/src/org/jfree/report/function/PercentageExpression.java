...
/**
 * Computes the percentage for a destColumn in relation to a base destColumn.
 * <p/>
...
public class PercentageExpression extends AbstractExpression
{
  ...
  /**
     * Return the current function value. <P> The value is calculated as the quotient of two columns: the dividend destColumn
     * and the divisor destColumn.  If the divisor is zero, the return value is "n/a";
     *
     * @return The quotient
     */
