 ...
 *
 * ------------
 * HideElementIfDataAvailableExpression.java
 * ------------
 * (C) Copyright 2001-2007, by Object Refinery Ltd, Pentaho Corporation and Contributors.
 */
...
/**
 * This functions checks the tablemodel and shows the named band, if there
...
public class HideElementIfDataAvailableExpression extends AbstractElementFormatFunction
{
  ...
  /**
   * Computes, if there is data available. This checks the report's data-row and searches for the number of rows
