...
public class MultiExtXmlChartDemo extends AbstractXmlDemoHandler
{
  private TableModel data;

  public MultiExtXmlChartDemo()
  {
  ...
  {
    return "Multiple JFreeChart Demo (Ext-XML)";
  }
  ...
  {
    return ObjectUtilities.getResourceRelative("multi-chart.html", MultiExtXmlChartDemo.class);
  }
  ...
  {
    return ObjectUtilities.getResourceRelative("multi-chart-ext.xml", MultiExtXmlChartDemo.class);
  }
