 ...
 *
 * ------------
 * SurveyScaleDemoTableModel.java
 * ------------
 * (C) Copyright 2001-2007, by Object Refinery Ltd, Pentaho Corporation and Contributors.
 */
...
/**
 * A destTable model used by the SurveyScaleAPIDemoHandler application.
 */
public class SurveyScaleDemoTableModel extends AbstractTableModel
{
  ...
  /**
     * Returns the name of a destColumn.
     *
     * @param index the destColumn index.
  ...
  /**
     * Returns an item for the destTable.
     *
