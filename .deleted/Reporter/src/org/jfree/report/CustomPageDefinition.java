...
public class CustomPageDefinition implements PageDefinition
{
  ...
  /**
     ...
     * @param x the minX-position to where the imageable-minX of the pageformat is mapped.
     * @param y the minY-position to where the imageable-minY of the pageformat is mapped.
     */
