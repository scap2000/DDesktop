...
public class HtmlZipExportDialog extends AbstractExportDialog
{
  ...
  public static final String HTML_OUTPUT_ENCODING
          = "org.jfree.report.modules.output.table.html.Encoding"; //$NON-NLS-1$
  /**
  ...
  private void initialize()
  {
    ...
    final boolean advancedSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.html.zip.AdvancedSettingsAvailable"));
    final boolean metaDataSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.html.zip.MetaDataSettingsAvailable"));
  ...
  protected Configuration grabDialogContents(final boolean full)
  {
    ...
    if (full)
    {
      p.setProperty("org.jfree.report.modules.gui.html.ExportMethod", "zip"); //$NON-NLS-1$ //$NON-NLS-2$
      p.setProperty("org.jfree.report.modules.gui.html.zip.DataDirectory", getDataFilename()); //$NON-NLS-1$
      p.setProperty("org.jfree.report.modules.gui.html.zip.TargetFileName", getFilename()); //$NON-NLS-1$
    }

    p.setConfigProperty("org.jfree.report.modules.output.table.html.Keywords", getKeywords()); //$NON-NLS-1$
    p.setConfigProperty("org.jfree.report.modules.output.table.html.Description", getDescription()); //$NON-NLS-1$
    p.setConfigProperty("org.jfree.report.modules.output.table.html.Author", getAuthor()); //$NON-NLS-1$
    p.setConfigProperty("org.jfree.report.modules.output.table.html.Encoding", getEncoding()); //$NON-NLS-1$
    p.setConfigProperty("org.jfree.report.modules.output.table.html.Title", getHTMLTitle()); //$NON-NLS-1$
    p.setConfigProperty("org.jfree.report.modules.output.table.html.StrictLayout", String.valueOf(isStrictLayout())); //$NON-NLS-1$
    return p;
  }

  protected void setDialogContents(final Configuration p)
  {
    setHTMLTitle(p.getConfigProperty("org.jfree.report.modules.output.table.html.Title", //$NON-NLS-1$
        p.getConfigProperty("org.jfree.report.metadata.Title"))); //$NON-NLS-1$
    setAuthor(p.getConfigProperty("org.jfree.report.modules.output.table.html.Author", //$NON-NLS-1$
        p.getConfigProperty("org.jfree.report.metadata.Author"))); //$NON-NLS-1$
    setKeywords(p.getConfigProperty("org.jfree.report.modules.output.table.html.Keywords", //$NON-NLS-1$
        p.getConfigProperty("org.jfree.report.metadata.Keywords"))); //$NON-NLS-1$
    setDescription(p.getConfigProperty("org.jfree.report.modules.output.table.html.Description", //$NON-NLS-1$
        p.getConfigProperty("org.jfree.report.metadata.Description"))); //$NON-NLS-1$

    setStrictLayout("true".equals(p.getConfigProperty //$NON-NLS-1$
            ("org.jfree.report.modules.output.table.html.StrictLayout"))); //$NON-NLS-1$
    ...
    setDataFilename(p.getConfigProperty
        ("org.jfree.report.modules.gui.html.zip.DataDirectory", "")); //$NON-NLS-1$ //$NON-NLS-2$
    setFilename(p.getConfigProperty
        ("org.jfree.report.modules.gui.html.zip.TargetFileName", "")); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  protected void performSelectFileZip ()
  {
    ...
    if (fileChooserZip == null)
    {
      ...
      fileChooserZip.addChoosableFileFilter
              (new FilesystemFilter(new String[]{ZIP_FILE_EXTENSION, JAR_FILE_EXTENSION},
    ...
    if (option == JFileChooser.APPROVE_OPTION)
    {
      ...
      // Test if ends on xls
      if (StringUtils.endsWithIgnoreCase(selFileName, ZIP_FILE_EXTENSION) == false)
      {
  ...
  {
    return HtmlZipExportPlugin.BASE_RESOURCE_CLASS;
  }

  protected String getConfigurationPrefix()
  {
    return "org.jfree.report.modules.gui.html.zip."; //$NON-NLS-1$
  }
}
