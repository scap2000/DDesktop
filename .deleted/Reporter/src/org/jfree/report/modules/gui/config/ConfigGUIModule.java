 ...
 */
public class ConfigGUIModule extends AbstractModule
{
  public static final String NAMESPACE =
      "http://jfreereport.sourceforge.net/namespaces/config-description"; //$NON-NLS-1$
  
  public static final String BUNDLE_NAME = "org.jfree.report.modules.gui.config.messages.messages"; //$NON-NLS-1$
