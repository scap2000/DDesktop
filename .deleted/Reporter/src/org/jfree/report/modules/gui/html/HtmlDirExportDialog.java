...
public class HtmlDirExportDialog extends AbstractExportDialog
{
  ...
  private void initialize()
  {
    ...
    final boolean advancedSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.html.file.AdvancedSettingsAvailable"));
    final boolean metaDataSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.html.file.MetaDataSettingsAvailable"));
  ...
  protected Configuration grabDialogContents(final boolean full)
  {
    ...
    if (full)
    {
      p.setConfigProperty("org.jfree.report.modules.gui.html.file.DataDirectory", getDataFilename()); //$NON-NLS-1$
      p.setConfigProperty("org.jfree.report.modules.gui.html.file.TargetFileName", getFilename()); //$NON-NLS-1$
    }
  ...
  protected void setDialogContents(final Configuration p)
  {
    ...
    setDataFilename(p.getConfigProperty
        ("org.jfree.report.modules.gui.html.file.DataDirectory", "")); //$NON-NLS-1$ //$NON-NLS-2$
    setFilename(p.getConfigProperty
        ("org.jfree.report.modules.gui.html.file.TargetFileName", "")); //$NON-NLS-1$ //$NON-NLS-2$
  }
  ...
  protected void performSelectFile()
  {
    ...
    if (fileChooserHtml == null)
    {
      ...
      fileChooserHtml.addChoosableFileFilter
          (new FilesystemFilter(new String[]{HtmlDirExportDialog.HTML_FILE_EXTENSION, HtmlDirExportDialog.HTM_FILE_EXTENSION},
  ...
  {
    return "org.jfree.report.modules.gui.html.file."; //$NON-NLS-1$
  }
}
