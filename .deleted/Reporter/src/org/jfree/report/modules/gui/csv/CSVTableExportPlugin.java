...
public class CSVTableExportPlugin extends AbstractExportActionPlugin
{
  ...
  {
    resources = new ResourceBundleSupport(CSVTableExportPlugin.BASE_RESOURCE_CLASS);
  }
  ...
  {
    return "org.jfree.report.modules.gui.csv.export.table."; //$NON-NLS-1$
  }
  ...
  public boolean performExport(final JFreeReport report)
  {
    ...
    final boolean result = performShowExportDialog
        (report, "org.jfree.report.modules.gui.csv.table.Dialog"); //$NON-NLS-1$
    if (result == false)
    {
    ...
    if (isProgressDialogEnabled(report, "org.jfree.report.modules.gui.csv.table.ProgressDialogEnabled"))
    {
  ...
  {
    return resources.getKeyStroke("action.export-to-csv.table.accelerator"); //$NON-NLS-1$
  }
  ...
  {
    return resources.getMnemonic("action.export-to-csv.table.mnemonic"); //$NON-NLS-1$
  }
}
