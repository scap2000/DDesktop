...
import org.jfree.report.modules.gui.commonswing.FormValidator;
import org.jfree.report.modules.gui.commonswing.NumericDocument;
...
public class NumericInputDialog extends JDialog
{
  ...
  {
    System.out.println(showSliderDialog(null, 1, "Title", "Message", 0, 100, 50));
    System.out.println(showInputDialog(null, 2, "Title", "Message", 0, 100, 50, true));
  }
}
