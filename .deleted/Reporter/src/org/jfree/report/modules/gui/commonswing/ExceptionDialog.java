 ...
 *
 * ------------
 * $Id: ExceptionDialog.java 3582 2007-10-23 20:18:15Z tmorgner $
 * ------------
...
public class ExceptionDialog extends JDialog
{
  ...
  private final class OKAction extends AbstractAction
  {
    ...
    private OKAction ()
    {
      putValue(NAME, UIManager.getDefaults().getString("OptionPane.okButtonText")); //$NON-NLS-1$
    }
  ...
  private String readFromException (final Exception e)
  {
    ...
    {
      Log.info(messages.getString("ExceptionDialog.INFO_EXCEPTION_SUPRESSED")); //$NON-NLS-1$
    }
    return text;
  }
          ...
          (final String title, final String message, final Exception e)
  {
    ...
    if (e != null)
    {
      final Messages messages = new Messages(SwingCommonModule.BUNDLE_NAME);
      Log.error(messages.getErrorString("ExceptionDialog.ERROR_0001_USER_ERROR"), e); //$NON-NLS-1$
    }
