...
public class HtmlStreamExportDialog extends AbstractExportDialog
{
  ...
  private void initialize ()
  {
    ...
    final boolean advancedSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.html.stream.AdvancedSettingsAvailable"));
    final boolean metaDataSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.html.stream.MetaDataSettingsAvailable"));
  ...
  protected Configuration grabDialogContents(final boolean full)
  {
    ...
    if (full)
    {
      p.setProperty("org.jfree.report.modules.gui.html.stream.TargetFileName", getFilename()); //$NON-NLS-1$
    }
  ...
  protected void setDialogContents(final Configuration p)
  {
    ...
    setFilename(p.getConfigProperty
        ("org.jfree.report.modules.gui.html.stream.TargetFileName", "")); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  protected void performSelectFile ()
  {
    ...
    if (fileChooserHtml == null)
    {
      ...
      fileChooserHtml.addChoosableFileFilter
              (new FilesystemFilter(new String[]{HtmlStreamExportDialog.HTML_FILE_EXTENSION, HtmlStreamExportDialog.HTM_FILE_EXTENSION},
  ...
  {
    return "org.jfree.report.modules.gui.html.stream."; //$NON-NLS-1$
  }
}
