...
public class PdfExportDialog extends AbstractExportDialog
{
  ...
  private void initializeComponents ()
  {
    ...
    final boolean advancedSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.pdf.AdvancedSettingsAvailable"));
    final boolean metaDataSettingsTabAvail =
        "true".equals(config.getConfigProperty("org.jfree.report.modules.gui.pdf.MetaDataSettingsAvailable"));
    if (advancedSettingsTabAvail || metaDataSettingsTabAvail)
    {
    ...
    {
      setContentPane(createContentPane(exportPane));
    }
  ...
  protected boolean performConfirm()
  {
            ...
            || getEncryptionValue().equals(PdfExportGUIModule.SECURITY_ENCRYPTION_40BIT))
    {
      ...
      {
        if (JOptionPane.showConfirmDialog(this,
                getResources().getString("pdfsavedialog.ownerpasswordEmpty"), //$NON-NLS-1$
  ...
  protected boolean performValidate()
  {
    ...
    if (filename.trim().length() == 0)
    {
      getStatusBar().setStatus(StatusType.ERROR,
              getResources().getString("pdfsavedialog.targetIsEmpty")); //$NON-NLS-1$
      return false;
    }
    final File f = new File(filename);
    if (f.exists())
    {
      ...
      final String message = MessageFormat.format(getResources().getString
              ("pdfsavedialog.targetOverwriteWarning"), //$NON-NLS-1$
              new Object[]{filename});
            ...
            || getEncryptionValue().equals(PdfExportGUIModule.SECURITY_ENCRYPTION_40BIT))
    {
      ...
      {
        getStatusBar().setStatus(StatusType.ERROR,
                getResources().getString("pdfsavedialog.userpasswordNoMatch")); //$NON-NLS-1$
        return false;
      }
      ...
      {
        getStatusBar().setStatus(StatusType.ERROR,
                getResources().getString("pdfsavedialog.ownerpasswordNoMatch")); //$NON-NLS-1$
        return false;
      }
    }
  ...
  protected void initializeFromJob(final JFreeReport job, final GuiContext guiContext)
  {
  ...
  {
    return "org.jfree.report.modules.gui.pdf."; //$NON-NLS-1$
  }
  ...
  protected Configuration grabDialogContents(final boolean full)
  {
    ...
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.Keywords", //$NON-NLS-1$
        txKeywords.getText());
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.Description", //$NON-NLS-1$
        txDescription.getText());
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.Author", //$NON-NLS-1$
        txAuthor.getText());
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.Title", //$NON-NLS-1$
        txTitle.getText());

    config.setConfigProperty("org.jfree.report.modules.gui.pdf.TargetFileName", //$NON-NLS-1$
        txFilename.getText());
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.Encoding", //$NON-NLS-1$
        encodingModel.getSelectedEncoding());

    config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.PrintLevel", //$NON-NLS-1$
        getPrintLevel());
    config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.Encryption", //$NON-NLS-1$
        getEncryptionValue());
    config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.UserPassword", //$NON-NLS-1$
        txUserPassword.getText());
    config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.OwnerPassword", //$NON-NLS-1$
        txOwnerPassword.getText());
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowAssembly", //$NON-NLS-1$
        String.valueOf(cxAllowAssembly.isSelected()));
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowCopy", //$NON-NLS-1$
        String.valueOf(cxAllowCopy.isSelected()));
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowFillIn", //$NON-NLS-1$
        String.valueOf(cxAllowFillIn.isSelected()));
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowModifyAnnotations", //$NON-NLS-1$
        String.valueOf(cxAllowModifyAnnotations.isSelected()));
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowModifyContents", //$NON-NLS-1$
        String.valueOf(cxAllowModifyContents.isSelected()));
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowScreenReaders", //$NON-NLS-1$
        String.valueOf(cxAllowScreenReaders.isSelected()));
    config.setConfigProperty("org.jfree.report.modules.output.pageable.pdf.EmbedFonts", //$NON-NLS-1$
  ...
  {
    txFilename.setText(config.getConfigProperty("org.jfree.report.modules.gui.pdf.TargetFileName")); //$NON-NLS-1$
    final String encoding = config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.Encoding"); //$NON-NLS-1$
    if (encoding != null && encoding.length() > 0)
    {
      encodingModel.setSelectedEncoding(encoding);
    }
    setPrintLevel(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.security.PrintLevel")); //$NON-NLS-1$
    setEncryptionValue(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.security.Encryption")); //$NON-NLS-1$

    txUserPassword.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.UserPassword")); //$NON-NLS-1$
    txOwnerPassword.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.OwnerPassword")); //$NON-NLS-1$
    txConfUserPassword.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.UserPassword")); //$NON-NLS-1$
    txConfOwnerPassword.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.OwnerPassword")); //$NON-NLS-1$

    cxAllowAssembly.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowAssembly"))); //$NON-NLS-1$
    cxAllowCopy.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowCopy"))); //$NON-NLS-1$
    cxAllowFillIn.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowFillIn"))); //$NON-NLS-1$
    cxAllowModifyAnnotations.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowModifyAnnotations"))); //$NON-NLS-1$
    cxAllowModifyContents.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowModifyContents"))); //$NON-NLS-1$
    cxAllowScreenReaders.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.AllowScreenReaders"))); //$NON-NLS-1$
    cxEmbedded.setSelected("true".equals //$NON-NLS-1$
        (config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.EmbedFonts"))); //$NON-NLS-1$

    txTitle.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.Title", //$NON-NLS-1$
        config.getConfigProperty("org.jfree.report.metadata.Title"))); //$NON-NLS-1$
    txAuthor.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.Author", //$NON-NLS-1$
        config.getConfigProperty("org.jfree.report.metadata.Author"))); //$NON-NLS-1$
    txKeywords.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.Keywords", //$NON-NLS-1$
        config.getConfigProperty("org.jfree.report.metadata.Keywords"))); //$NON-NLS-1$
    txDescription.setText(config.getConfigProperty("org.jfree.report.modules.output.pageable.pdf.Description", //$NON-NLS-1$
        config.getConfigProperty("org.jfree.report.metadata.Description"))); //$NON-NLS-1$
  }
  ...
  public void clear()
  {
    ...
    txAuthor.setText(JFreeReportBoot.getInstance().getGlobalConfig().getConfigProperty("user.name", "")); //$NON-NLS-1$ //$NON-NLS-2$
    txFilename.setText(""); //$NON-NLS-1$
  ...
  public void setEncryptionValue(final String b)
  {
    if (b != null)
    {
      ...
      {
        Log.warn("Invalid encryption value entered. " + b); //$NON-NLS-1$
      }
    }
    rbSecurityNone.setSelected(true);
    updateSecurityPanelEnabled();
