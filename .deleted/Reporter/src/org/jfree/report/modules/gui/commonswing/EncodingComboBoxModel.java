 ...
 *
 * ------------
 * $Id: EncodingComboBoxModel.java 3510 2007-10-15 10:00:14Z tmorgner $
 * ------------
...
public class EncodingComboBoxModel implements ComboBoxModel
{
  ...
  public static final String AVAILABLE_ENCODINGS
          = "org.jfree.report.modules.gui.base.EncodingsAvailable"; //$NON-NLS-1$
  ...
  public static final String ENCODINGS_DEFINITION_FILE
          = "org.jfree.report.modules.gui.base.EncodingsFile"; //$NON-NLS-1$
  ...
  public static final String ENCODINGS_DEFINITION_FILE_DEFAULT
          = "org/jfree/report/modules/gui/commonswing/jfreereport-encodings.properties"; //$NON-NLS-1$
  ...
  public static final String BUNDLE_NAME = "org.jfree.report.modules.gui.commonswing.encoding-names"; //$NON-NLS-1$
  ...
  public void ensureEncodingAvailable (final String encoding)
  {
    if (encoding == null)
    {
      throw new NullPointerException(messages.getErrorString("EncodingComboBoxModel.ERROR_0001_ENCODING_CANNOT_BE_NULL")); //$NON-NLS-1$
    }
  ...
  public static EncodingComboBoxModel createDefaultModel (final Locale locale)
  {
    ...
    if (allEncodings || availEncs.equals(AVAILABLE_ENCODINGS_FILE))
    {
      ...
      if (in == null)
      {
        ...
        Log.warn(messages.getString("EncodingComboBoxModel.WARN_ENCODING_FILE_NOT_FOUND", encFile)); //$NON-NLS-1$
      }
      else
      {
        try
...
//          final Properties defaultEncodings = getDefaultEncodings();
        ...
        catch (IOException e)
        {
          ...
          Log.warn(new Log.SimpleMessage
                  (messages.getString("EncodingComboBoxModel.WARN_ERROR_READING_ENCODING_FILE", encFile), e)); //$NON-NLS-1$
        }
      }
    }
    return ecb;
