 ...
 * {@link ExcelExportDialog#performQueryForExport(org.jfree.report.JFreeReport,
    org.jfree.report.modules.gui.commonswing.SwingGuiContext)}.
...
public class ExcelExportDialog extends AbstractExportDialog
{
  ...
  protected void performSelectFile()
  {
    if (fileChooser == null)
    {
      ...
      final FilesystemFilter filter = new FilesystemFilter(XLS_FILE_EXTENSION,
    ...
    if (option == JFileChooser.APPROVE_OPTION)
    {
      ...
      // Test if ends on xls
      if (StringUtils.endsWithIgnoreCase(selFileName, XLS_FILE_EXTENSION) == false)
      {
        selFileName = selFileName + XLS_FILE_EXTENSION;
      }
