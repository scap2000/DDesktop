 ...
 *
 * ------------
 * $Id: GoToLastPageActionPlugin.java 3320 2007-09-10 18:59:59Z tmorgner $
 * ------------
    ...
    implements ControlActionPlugin
{
  ...
  {
    return "org.jfree.report.modules.gui.base.go-to-last."; //$NON-NLS-1$
  }
  ...
  {
    return resources.getKeyStroke("action.lastpage.accelerator"); //$NON-NLS-1$
  }
  ...
  {
    return resources.getMnemonic("action.lastpage.mnemonic"); //$NON-NLS-1$
  }
