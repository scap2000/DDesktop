...
public class CSVDataExportDialog extends AbstractExportDialog
{
  ...
  private void initialize()
  {
    ...
    if ("true".equals(config.getConfigProperty("org.jfree.report.modules.gui.csv.data.AdvancedSettingsAvailable")))
    {
  ...
  protected void setDialogContents(final Configuration config)
  {
    ...
    final String tableCSVSeparator = config.getConfigProperty
        (CSVTableModule.CONFIGURATION_PREFIX + '.' + CSVTableModule.SEPARATOR_KEY, COMMA_SEPARATOR);
    ...
    final String encoding = config.getConfigProperty (CSV_OUTPUT_ENCODING, CSV_OUTPUT_ENCODING_DEFAULT);
  ...
  protected void performSelectFile()
  {
    if (fileChooser == null)
    {
      ...
      final ExtensionFileFilter filter = new ExtensionFileFilter
          (getResources().getString("csvexportdialog.csv-file-description"), CSV_FILE_EXTENSION); //$NON-NLS-1$
