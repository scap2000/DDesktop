...
public class RTFExportPlugin extends AbstractExportActionPlugin
{
  ...
  public static final String BASE_RESOURCE_CLASS =
          "org.jfree.report.modules.gui.rtf.messages.messages"; //$NON-NLS-1$
  ...
  public boolean initialize(final SwingGuiContext context)
  {
    ...
    if (JFreeReportBoot.getInstance().isModuleAvailable(RTFExportGUIModule.class.getName()) == false)
    {
      return false;
    }
    return true;
  ...
  {
    return "org.jfree.report.modules.gui.rtf.export."; //$NON-NLS-1$
  }
  ...
  public boolean performExport (final JFreeReport report)
  {
    final boolean result = performShowExportDialog
        (report, "org.jfree.report.modules.gui.rtf.Dialog"); //$NON-NLS-1$
    if (result == false)
    {
    ...
    if (isProgressDialogEnabled(report, "org.jfree.report.modules.gui.rtf.ProgressDialogEnabled"))
    {
    ...
    {
      getContext().getStatusListener().setStatus(StatusType.ERROR, resources.getString("RTFExportPlugin.USER_FAILED")); //$NON-NLS-1$
      return false;
    }
  }
  ...
  {
    return resources.getKeyStroke("action.export-to-rtf.accelerator"); //$NON-NLS-1$
  }
  ...
  {
    return resources.getMnemonic("action.export-to-rtf.mnemonic"); //$NON-NLS-1$
  }
