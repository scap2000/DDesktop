 ...
 *
 * ------------
 * $Id: GoToFirstPageActionPlugin.java 3296 2007-09-07 15:43:06Z tmorgner $
 * ------------
    ...
    implements ControlActionPlugin
{
  ...
  {
    return "org.jfree.report.modules.gui.base.go-to-first."; //$NON-NLS-1$
  }
  ...
  {
    return resources.getKeyStroke("action.firstpage.accelerator"); //$NON-NLS-1$
  }
  ...
  {
    return resources.getMnemonic("action.firstpage.mnemonic"); //$NON-NLS-1$
  }
