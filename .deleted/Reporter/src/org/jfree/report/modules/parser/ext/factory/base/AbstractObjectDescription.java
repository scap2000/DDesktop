    ...
    implements ObjectDescription, Cloneable
{
  ...
  public void setParameter(final String name, final Object value)
  {
    ...
    final Class parameterClass = convertPrimitiveClass
  ...
  /**
   * Returns a cloned instance of the object description. The contents of the
   * parameter objects collection are cloned too, so that any already defined
   * parameter value is copied to the new instance.
   * <p/>
   * Parameter definitions are not cloned, as they are considered read-only.
   * <p/>
   * The newly instantiated object description is not configured. If it need
   * to be configured, then you have to call configure on it.
   *
