...
public class AnchorFieldReadHandler extends AbstractElementReadHandler
{
  ...
  protected void startParsing (final PropertyAttributes atts)
          throws SAXException
  {
    elementFactory.setName(atts.getValue(getUri(), NAME_ATT));

    final String posX = atts.getValue(getUri(), "x");
    if (posX != null)
    {
      elementFactory.setX(new Float(ReportParserUtil.parseRelativeFloat
    ...
    if (posY != null)
    {
      elementFactory.setY(new Float(ReportParserUtil.parseRelativeFloat
