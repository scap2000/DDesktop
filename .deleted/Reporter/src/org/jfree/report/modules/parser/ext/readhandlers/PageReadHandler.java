...
public class PageReadHandler extends AbstractPropertyXmlReadHandler
{
          ...
          throws SAXException
  {
    ...
    defTopMargin = ParserUtil.parseFloat(atts.getValue(getUri(), TOPMARGIN_ATT), defTopMargin);
    defBottomMargin = ParserUtil.parseFloat(atts.getValue(getUri(), BOTTOMMARGIN_ATT), defBottomMargin);
    defLeftMargin = ParserUtil.parseFloat(atts.getValue(getUri(), LEFTMARGIN_ATT), defLeftMargin);
    defRightMargin = ParserUtil.parseFloat(atts.getValue(getUri(), RIGHTMARGIN_ATT), defRightMargin);
          ...
          throws SAXException
  {
    ...
    if (atts.getValue(getUri(), WIDTH_ATT) != null && atts.getValue(getUri(), HEIGHT_ATT) != null)
    {
