 ...
 *
 * ------------
 * IBMCompatiblePrinterDriver.java
 * ------------
 * (C) Copyright 2001-2007, by Object Refinery Ltd, Pentaho Corporation and Contributors.
 */
...
import org.jfree.report.modules.output.pageable.plaintext.helper.EncodingUtilities;
    ...
    public PrinterEncoding getEncoding (final String encoding)
    {
      try
      {
        return new PrinterEncoding
                (encoding, encoding, encoding, IBMCompatiblePrinterDriver.GenericIBMPrinterSpecification.translateCodePage(encoding));
      }
