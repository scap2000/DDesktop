 ...
 *
 * ------------
 * CSVOutputProcessorMetaData.java
 * ------------
 * (C) Copyright 2001-2007, by Object Refinery Ltd, Pentaho Corporation and Contributors.
 */

package org.jfree.report.modules.output.table.csv.helper;
...
public class CSVOutputProcessorMetaData extends AbstractOutputProcessorMetaData
{
  ...
  public CSVOutputProcessorMetaData(final Configuration configuration, final int paginationMode)
  {
    super(configuration);
    final String localStrict = configuration.getConfigProperty("org.jfree.report.modules.output.table.csv.StrictLayout");
    if (localStrict != null)
    {
    ...
    if ("true".equals(configuration.getConfigProperty("org.jfree.report.modules.output.table.csv.UsePageBands")))
    {
      addFeature(OutputProcessorFeature.PAGE_SECTIONS);
    }
