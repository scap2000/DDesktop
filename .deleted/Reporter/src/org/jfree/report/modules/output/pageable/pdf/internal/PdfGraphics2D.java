...
public class PdfGraphics2D extends Graphics2D
{
  ...
  private float jpegQuality = 0.950f;
   ...
   */
  protected PdfGraphics2D(final PdfContentByte cb,
                final float width,
                final float height,
                            ...
                            final ImageObserver obs)
  {
    ...
    try
    {
      ...
      if (convertImagesToJPEG)
      {
        ...
        final MemoryByteArrayOutputStream baos = new MemoryByteArrayOutputStream();
    ...
    {
      Log.error ("Failed to draw the image: ", ex);
