...
public final class HtmlEncoderUtil
{
  ...
  /**
     * Encode a string to the "minX-www-form-urlencoded" form, enhanced with the
     * UTF-8-in-URL proposal. This is what happens:
     * <p/>
     * <ul> <li><p>The ASCII characters 'a' through 'z', 'A' through 'Z', and '0'
     ...
     * <p/>
     * <li><p>All other ASCII characters are converted into the 3-character string
     * "%xy", where xy is the two-digit hexadecimal representation of the
     * character code
     * <p/>
     * <li><p>All non-ASCII characters are encoded in two steps: first to a
     * sequence of 2 or 3 bytes, using the UTF-8 algorithm; secondly each of these
     * bytes is encoded as "%xx". </ul>
     *
  ...
  {
    return UTFEncodingUtil.encodeUTF8(s);
  }
