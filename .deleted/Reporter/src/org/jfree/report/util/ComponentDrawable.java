...
public class ComponentDrawable implements ExtendedDrawable
{
  ...
  public synchronized Dimension getPreferredSize()
  {
    ...
    {
      Log.warn("Failed to compute the preferred size.");
    }
    return new Dimension(0, 0);
  }
  ...
  public synchronized Dimension getSize()
  {
    ...
    {
      Log.warn("Failed to compute the defined size.");
    }
    return new Dimension(0, 0);
  }
   ...
   */
  public synchronized void draw(final Graphics2D g2, final Rectangle2D area)
  {
    if (component == null)
    {
      return;
