...
public final strictfp class ShapeTransform
{
  ...
  /**
     ...
     *
     * @param s the shape
     * @param x the minX coordinate where the shape is translated to
     * @param y the minY coordinate where the shape is translated to
  ...
  /**
     ...
     *
     * @param x1 starting minX of line
     * @param y1 starting minY of line
     * @param x2 ending minX of line
     * @param y2 ending minY of line
     * @param xmin lower left minX of rectangle
     * @param xmax upper right minX of rectangle
     * @param ymin lower left minY of rectangle
     * @param ymax upper right minY of rectangle
  ...
  /**
     * Intersect two lines.
     *
     * @param x11 starting minX of 1st line
     * @param y11 starting minY of 1st line
     * @param x12 ending minX of 1st line
     * @param y12 ending minY of 1st line
     * @param x21 starting minX of 2nd line
     * @param y21 starting minY of 2nd line
     * @param x22 ending minX of 2nd line
     * @param y22 ending minY of 2nd line
