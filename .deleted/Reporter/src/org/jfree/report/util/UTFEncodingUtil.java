...
public class UTFEncodingUtil
{
  ...
  /**
   * Encodes the given string using the encoding defined in the report configuration. The encoding will be read from the
      ...
      throws UnsupportedEncodingException
  {
    ...
    final String encoding = configuration.getConfigProperty("org.jfree.report.URLEncoding");
