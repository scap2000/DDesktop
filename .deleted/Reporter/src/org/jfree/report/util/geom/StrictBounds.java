...
{
  /**The minX-coordinate of the upper left corner.
     */
  private long x;
  /**The minY-coordinate of the upper left corner.
     */
  private long y;
  ...
  /**
     ...
     *
     * @return the minX coordinate of the upper left corner of the framing rectangle.
     */
  public long getX ()
  {
    return x;
  ...
  /**
     ...
     * rectangle in micro points.
     *
     * @return the minY coordinate of the upper left corner of the framing rectangle.
     */
  public long getY ()
  {
    return y;
  ...
  /**
     ...
     *
     * @param x the minX-coordinate of the point.
     * @param y the minY-coordinate of the point.
