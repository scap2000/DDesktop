...
public class MainPanel extends BasicPanel {
    ...
    private BasicButton btnResourcesControl = new BasicButton(IconTypes.resources_32x32);
	...
	btnResourcesControl.setRolloverIcon(IconTypes.resources_ro_32x32);
	...
	//Environment.mainTabbedPane.setSelectedIndex(Environment.getDesktopIndex(Environment.MODULE_TASKS));
    }
