...
import org.digitall.projects.apps.dbadmin.DBAdminApp;
...
public class MainPanel extends BasicPanel {
    ...
    private BasicButton btnMain = new BasicButton(IconTypes.admin_32x32);
    private BasicButton btnCashflowAdmin = new BasicButton(IconTypes.cashflow_admin_32x32);
    private BasicButton btnResourcesRequests = new BasicButton(IconTypes.resources_requests_32x32);
    private BasicButton btnResourcesControl = new BasicButton(IconTypes.resources_admin_32x32);
    private BasicButton btnLogistics = new BasicButton(IconTypes.logistics_32x32);
    private BasicButton btnTasks = new BasicButton(IconTypes.tasks_32x32);
    private BasicButton btnSystemMap = new BasicButton(IconTypes.system_map);
	...
	btnMain.setRolloverIcon(IconTypes.admin_ro_32x32);
	...
	btnCashflowAdmin.setRolloverIcon(IconTypes.cashflow_admin_ro_32x32);
	...
	btnResourcesRequests.setRolloverIcon(IconTypes.resources_requests_ro_32x32);
	...
	btnResourcesControl.setRolloverIcon(IconTypes.resources_admin_ro_32x32);
	...
	btnTasks.setRolloverIcon(IconTypes.tasks_ro_32x32);
	...
	btnSystemMap.setRolloverIcon(IconTypes.system_map_ro);
	...
	btnCashflowAdmin.setToolTipText(Environment.MODULE_CASHFLOWADMIN);
	btnResourcesRequests.setToolTipText(Environment.MODULE_RESOURCESREQUESTS);
	btnResourcesControl.setToolTipText(Environment.MODULE_RESOURCES);
	btnTasks.setToolTipText(Environment.MODULE_COMMANDCENTER);
	lblSeparator1.addMouseListener(new MouseAdapter() {

				    public void mouseClicked(MouseEvent e) {
					lblSeparator1_mouseClicked(e);
				    }
