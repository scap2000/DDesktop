...
public class MainFrame extends JFrame {
	...
	desktops[4] = new BasicDesktop(4, Environment.MODULE_COMMANDCENTER);
	desktops[5] = new BasicDesktop(5, Environment.MODULE_STICKYNOTES);
	desktops[6] = new BasicDesktop(6, Environment.MODULE_SYSTEMMAP);
	...
	if (active) {
	    ...
	    Boot.rcSystemMapModule(Boot.INIT_START, Environment.getDesktop(Environment.MODULE_SYSTEMMAP));
