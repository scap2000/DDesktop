...
public class Wizard extends BasicDialog {
    ...
    private BasicLabel lblInformation = new BasicLabel();
    private int idFile = -1;

    public Wizard(Manager _mgmt) {
	try {
	    setManager(_mgmt);
	    jbInit();
	} catch (Exception e) {
	...
	btnNext.setBounds(new Rectangle(425, 505, 40, 28));
	...
	btnPrevious.setBounds(new Rectangle(375, 505, 40, 28));
	...
	btnClose.setBounds(new Rectangle(670, 505, 40, 28));
	...
	btnIndexStep0.setContentAreaFilled(false);
	...
	btnIndexStep1.setContentAreaFilled(false);
	...
	btnIndexStep2.setContentAreaFilled(false);
	...
	btnIndexStep3.setContentAreaFilled(false);
	...
	btnIndexStep4.setContentAreaFilled(false);
	...
	btnIndexStep5.setContentAreaFilled(false);
	...
	btnIndexStep6.setContentAreaFilled(false);
	...
	btnIndexStep7.setContentAreaFilled(false);
	...
	btnIndexStep8.setContentAreaFilled(false);
	...
	btnIndexStep9.setContentAreaFilled(false);
	...
	lblInformation.setText("MODULO EN DESARROLLO");
	lblInformation.setBounds(new Rectangle(320, 90, 215, 20));
	lblInformation.setFont(new Font("Default", 3, 14));
	lblInformation.setForeground(new Color(255, 66, 0));
	lblInformation.setSize(new Dimension(200, 20));
	lblInformation.setBackground(Color.yellow);
	...
	this.getContentPane().add(lblInformation, null);
	...
	for (int i = 0; i < lblVector.length; i++) {
	    lblVector[i].setVisible(false);
	}
	int qtyStep = mgmt.getQtyStep();
	for (int i = 0; i < qtyStep; i++) {
	    lblVector[i].setVisible(true);
	}
    }
    ...
    public void setLblInformation() {
	lblInformation.setText(mgmt.getTitleText());
    }
    ...
    /*
    public String getArg(int _index){
        return mgmt.getArgument(_index);
    }

    private void btnVer_actionPerformed(ActionEvent e) {
        System.out.println("Arg[1]: " +mgmt.getArgument(1));
    }*/
