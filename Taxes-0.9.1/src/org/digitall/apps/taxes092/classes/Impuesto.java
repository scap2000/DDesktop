...
public class Impuesto {
    ...
    public static final int TIPO_IMPUESTO_TGS = 1;
    public static final int TIPO_IMPUESTO_INMOB = 2;
    public static final int TIPO_IMPUESTO_AUTOMOTOR = 3;
    public static final int TIPO_IMPUESTO_ACTVARIAS = 4;
