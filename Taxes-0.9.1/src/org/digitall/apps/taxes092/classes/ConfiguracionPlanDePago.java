...
public class ConfiguracionPlanDePago {
    ...
    private int menorAnio = 0;   // menor año del periodo de la deuda sin incluir el periodo actual
    private int mayorAnio = 0;   // mayor año del periodo de la deuda sin incluir el periodo actual
    private int menorMes = 0;    // menor mes del periodo de la deuda sin incluir el periodo actual
    private int mayorMes = 0;    // mayor mes del periodo de la deuda sin incluir el periodo actual
    private int menorAnticipo = 0; // menor anticipo del periodo de la deuda sin incluir el periodo actual
    private int mayorAnticipo = 0; // menor anticipo del periodo de la deuda sin incluir el periodo actual
    private int cantidadAnticipos = 0; //cantidad de anticipos que adeuda sin incluir el actual
    private double capitalPuro = 0.0; //Deuda parcial sin incluir el anticipo actual
    private double interesPuro = 0.0; //interes por mora sin incluir el anticipo actual
    private double totalAnticiposAdeudadosPuro = 0.0; // SubTotal de la deuda sin incluir el anticipo actual
    
    /*Moratoria Pago al Contado*/
    private int menorAnioxContado = 0;   // menor año del periodo de la deuda deuda incluyendo el periodo actual
    private int mayorAnioxContado = 0;   // mayor año del periodo de la deuda deuda incluyendo el periodo actual
    private int menorMesxContado = 0;    // menor mes del periodo de la deuda deuda incluyendo el periodo actual
    private int mayorMesxContado = 0;    // mayor mes del periodo de la deuda deuda incluyendo el periodo actual
    private int menorAnticipoxContado = 0; // menor anticipo del periodo de la deuda deuda incluyendo el periodo actual
    private int mayorAnticipoxContado = 0; // menor anticipo del periodo de la deuda deuda incluyendo el periodo actual
    private int cantidadAnticiposxContado = 0; //cantidad de anticipos que adeuda deuda incluyendo el actual
    private double capitalPuroxContado = 0.0; //Deuda parcial deuda incluyendo el anticipo actual
    private double interesPuroxContado = 0.0; //interes por mora deuda incluyendo el anticipo actual
    private double totalAnticiposAdeudadosPuroxContado = 0.0; // SubTotal de la deuda incluyendo el anticipo actual
    private double totalPagoxContado = 0.0; // Total a pagar incluyendo el anticipo actual
    
    
    private double porcentajeCondonacionIntereses = 0.0; // Porcentaje por condonación de intereses
    private double montoCondonacionIntereses = 0.0; //monto por condonacion de intereses
    private double porcentajeBonificacion = 0.0; // porcentaje de descuento
    private double montoBonificacion = 0.0; // monto de descuento
    private double montoBonificacionCtdo = 0.0; //monto de descuento contando el ultimo anticipo
    ...
    //Valores relacionados a la entrega
    ...
    private double pagoAnticipado = 0.0; // monto del pago que se hace por la entrega
	...
	try {
		...
		menorAnio = configPlanDePago.getInt("menoranio");
	        ...
	        /*
		menorMes = configPlanDePago.getInt("menorMes");
	        mayorMes = configPlanDePago.getInt("mayorMes");
		*/
		...
		porcentajeCondonacionIntereses = _tipoPlanDePago.getPorcentajeCondonacionIntereses();
	        ...
	        porcentajeInteresFinanciacion = _tipoPlanDePago.getPorcentajeInteresCuota();
                ...
                /*Pago al Contado*/
	        menorAnioxContado = configPlanDePago.getInt("menoranioxcontado");;   // menor año del periodo de la deuda deuda incluyendo el periodo actual
	        mayorAnioxContado = configPlanDePago.getInt("mayoranioxcontado");   // mayor año del periodo de la deuda deuda incluyendo el periodo actual
	        /*menorMesxContado = configPlanDePago.getInt("menormesxcontado");    // menor mes del periodo de la deuda deuda incluyendo el periodo actual
	        mayorMesxContado = configPlanDePago.getInt("mayormesxcontado");    // mayor mes del periodo de la deuda deuda incluyendo el periodo actual
                */
	        menorAnticipoxContado = configPlanDePago.getInt("menoranticipoxcontado"); // menor anticipo del periodo de la deuda deuda incluyendo el periodo actual
	        mayorAnticipoxContado = configPlanDePago.getInt("mayoranticipoxcontado"); // menor anticipo del periodo de la deuda deuda incluyendo el periodo actual
	        cantidadAnticiposxContado = configPlanDePago.getInt("cantidadAnticiposxcontado"); //cantidad de anticipos que adeuda deuda incluyendo el actual
	        capitalPuroxContado = configPlanDePago.getDouble("montoBasePuroxContado"); //Deuda parcial deuda incluyendo el anticipo actual
	        interesPuroxContado = configPlanDePago.getDouble("interespuroxcontado"); //interes por mora deuda incluyendo el anticipo actual
	        totalAnticiposAdeudadosPuroxContado = configPlanDePago.getDouble("montototalPuroxContado"); // SubTotal de la deuda incluyendo el anticipo actual
