...
*/
/**
 * PanelRegistrarBoletaPagoContado.java
 *
 * */
...
public class PanelRegistrarBoletaPagoContado extends BasicPanel{
	...
	btnRegistrarBoleta.setToolTipText("Registrar Pago de Contado");
    ...
    private void btnGenerar_actionPerformed(ActionEvent e) {
        if(Advisor.question("Aviso","¿Está seguro de generar la boleta para " + coordinador.getPagoContado().getCantidadPeriodos()+" anticipos por un total de $ "+Format.money(coordinador.getPagoAnticipos().getMontoTotal())+"?")){
