...
public class MapEntity {
	...
	if (gid != -1) {
	    ResultSet data = LibSQL.exQuery("SELECT * FROM maps.entidades WHERE gid = " + gid);
	    try {
		if (data.next()) {
    ...
    public void setInitialPoint(Point2D.Double _initialPoint) {
