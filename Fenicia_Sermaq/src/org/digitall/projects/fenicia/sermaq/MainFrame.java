...
public class MainFrame extends JFrame {
	...
	try {
	    ...
	    /*endpatch*/
	    Login loginWindow = new Login(Environment.organization, Environment.defaultProvince, true, false);
	...
	this.setTitle(Environment.organization + " - " + Environment.defaultProvince);
	...
	desktops[3] = new BasicDesktop(3, Environment.MODULE_REPORTS);
	desktops[4] = new BasicDesktop(4, Environment.MODULE_STICKYNOTES);
	//desktops[5] = new BasicDesktop(5, Environment.MODULE_TASKS);
	//desktops[6] = new BasicDesktop(6, Environment.MODULE_STICKYNOTES);
	//desktops[7] = new BasicDesktop(7, Environment.MODULE_SYSTEMMAP);
	...
	if (active) {
	    ...
	    Boot.rcResources(Boot.INIT_START, Environment.getDesktop(Environment.MODULE_RESOURCES));
